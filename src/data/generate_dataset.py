...
lectura_datos_parallel(input_path='/app/data/raw', output_path='/app/data/processed', length=8, cycles='/app/src/resources/aux_respiratory_cycles.npy')

# Afterwards, create the Train-Test directories and split the spectrograms accordingly
cycles_train, cycles_test = split_patients_by_train_test(aux_file='/app/src/resources/aux_respiratory_cycles.npy', seed=args.seed, train_test_split=80)
